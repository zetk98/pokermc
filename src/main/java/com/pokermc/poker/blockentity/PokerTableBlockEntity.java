package com.pokermc.poker.blockentity;
...
public class PokerTableBlockEntity extends BlockEntity {
    ...
    public static void tick(World world, BlockPos pos, BlockState state, PokerTableBlockEntity be) {
        ...
        int turnSec = com.pokermc.common.config.PokerConfig.get().turnTimeSeconds;
        if (turnSec > 0) {
    ...
    // No custom persistence - game resets on server restart
