package com.pokermc.goldenticket.block;
...
public class GoldenTicketBlock extends BlockWithEntity {

    public GoldenTicketBlock(Settings settings) {
        super(settings);
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new GoldenTicketBlockEntity(pos, state);
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player,
        ...
        if (be instanceof GoldenTicketBlockEntity gt) {
            gt.openFor((net.minecraft.server.network.ServerPlayerEntity) player);
        }
