...
import com.pokermc.poker.game.HandEvaluator;
...
public class PokerTableScreen extends Screen {
    ...
    public void render(DrawContext ctx, int mouseX, int mouseY, float delta) {
        ...
        // Background texture
        ctx.drawTexture(RenderPipelines.GUI_TEXTURED, TEX_BG, tx, ty, 0, 0, tableW, tableH, 360, 230);
    ...
    private void drawCard(DrawContext ctx, int x, int y, String code) {
        ...
        ctx.drawTexture(RenderPipelines.GUI_TEXTURED, TEX_CARD_ATLAS, x, y, uv[0], uv[1], CARD_W, CARD_H, ATLAS_W, ATLAS_H);
    }
    ...
    private void drawCardSmall(DrawContext ctx, int x, int y, String code) {
        ...
        ctx.drawTexture(RenderPipelines.GUI_TEXTURED, TEX_CARD_ATLAS, x, y,
                (float)uv[0], (float)uv[1], SMALL_W, SMALL_H, CARD_W, CARD_H, ATLAS_W, ATLAS_H);
    }

    private void drawCardBackSmall(DrawContext ctx, int x, int y) {
        ctx.drawTexture(RenderPipelines.GUI_TEXTURED, TEX_CARD_BACK, x, y,
                0f, 0f, SMALL_W, SMALL_H, CARD_W, CARD_H, CARD_W, CARD_H);
    }
